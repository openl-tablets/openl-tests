...
public class SyncChangesDialogComponent extends BaseComponent {
    ...
    private void initializeElements() {
        ...
        // The select is matched by its own testid: antd stopped deriving the input id from the form name,
        // so the field now carries an autogenerated id (_r_NN_) and merge_branches_form_targetBranch is gone.
        branchSelector = createScopedElement("xpath=.//*[@data-testid='merge-target-branch']", "branchSelector");
